	...
	<div id="page">
	  ...
	  <div id="leftcol">
				...
				<div class="block">
					...
					$squ=mysql_query("select * from restaurant where Category='fast_food' and restaurent_name='nandus'");
					
					$result_count = mysql_num_rows($squ);
					if($result_count==0){
						echo '<h1>There is no Fast Food of <b style="color:#0FF">Nandus</b></h1>';
					}else{
