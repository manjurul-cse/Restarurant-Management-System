	...
	<div id="page">
	  ...
	  <div id="leftcol">
				...
				<div class="block">
					...
					$squ=mysql_query("select * from restaurant where Category='fast_food' and restaurent_name='Star Kabab'");
					
					$result_count = mysql_num_rows($squ);
					if($result_count==0){
						echo '<h1>There is no Fast Food of <b style="color:#0FF">Star Kabab</b></h1>';
					}else{
