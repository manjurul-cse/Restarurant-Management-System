...
<body>
	<div id="page">
	  <div id="header">
       ...
       <a href="../BANGLA/cfc.php"> <input type="button" value="Bangla Foods" style="background-color:#0F0; color:red" size="50px" height="20px"/>  
         </a>
	  ...
	  <div id="leftcol">
				...
				<div class="block">
					...
					$squ=mysql_query("select * from restaurant where Category='fast_food' and restaurent_name='cfc'");
					
					$result_count = mysql_num_rows($squ);
					if($result_count==0){
						echo '<h1>There is no Fast Food of <b style="color:#0FF">CFC</b></h1>';
					}else{
