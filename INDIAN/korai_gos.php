...
<body>
	<div id="page">
	  <div id="header">
       ...
       <a href="../BANGLA/korai_gos.php"> <input type="button" value="Bangla Foods" style="background-color:#0F0; color:red" size="50px" height="20px"/>  
         </a>
       <a href="../fast_foods/korai_gos.php"> 
       <input type="button" value="Fast Foods" style="background-color:#0F0" /> 
         </a>
       <a href="../THAI & CHINESE/korai_gos.php"> 
	  ...
	  <div id="leftcol">
				...
				<div class="block">
					...
					$squ=mysql_query("select * from restaurant where Category='Indian' and restaurent_name='korai gost'");
					
					$result_count = mysql_num_rows($squ);
					if($result_count==0){
						echo '<h1>There is no Indian Food of <b style="color:#0FF">korai gost</b></h1>';
					}else{
						
						if((isset($_SESSION['username']) and $_SESSION['username']=="admin")|| (isset($_SESSION['username']) and $_SESSION['username']=="korai gost")){
