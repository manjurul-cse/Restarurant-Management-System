...
<body>
	<div id="page">
	  <div id="header">
        ...
        <div id="content">
        <div id="back">
		<iframe width="940" height="300" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=olympia++restaurant++dhaka&amp;aq=&amp;sll=23.753021,90.370231&amp;sspn=0.011018,0.021136&amp;ie=UTF8&amp;hq=olympia+restaurant&amp;hnear=Dhaka,+Dhaka+Division,+Bangladesh&amp;t=m&amp;cid=6933701431745542677&amp;ll=23.746776,90.373449&amp;spn=0.005892,0.020149&amp;z=16&amp;iwloc=A&amp;output=embed"></iframe><br />
		
        <div id="footer"><center>
        <H1 style="color:red; font-size:24px" align="center">Other Foods</h1><br /><br /><span>
       <a href="../BANGLA/olympia.php"> <input type="button" value="Bangla Foods" style="background-color:#0F0; color:red" size="50px" height="20px"/>  
         </a>
      <a href="../fast_foods/olympia.php"> 
       <input type="button" value="Fast Foods" style="background-color:#0F0" /> 
         </a>
       <a href="../THAI & CHINESE/olympia.php"> 
	  ...
	  <div id="leftcol">
				...
				<div class="block">
					...
					$squ=mysql_query("select * from restaurant where Category='Indian' and restaurent_name='Olympia'");
					
					$result_count = mysql_num_rows($squ);
					if($result_count==0){
						echo '<h1>There is no Indian Food of <b style="color:#0FF">Olympia</b></h1>';
					}else{
						
						if((isset($_SESSION['username']) and $_SESSION['username']=="admin")|| (isset($_SESSION['username']) and $_SESSION['username']=="Olympia")){
