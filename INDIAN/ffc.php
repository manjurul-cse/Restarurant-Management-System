...
<body>
	<div id="page">
	  <div id="header">
        ...
        <div id="content">
        <div id="back">
		<iframe width="940" height="300" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=ffc++dhanmondi,+dhaka&amp;aq=&amp;sll=37.0625,-95.677068&amp;sspn=38.963048,86.572266&amp;ie=UTF8&amp;hq=ffc&amp;hnear=Dhanmondi,+Dhaka,+Dhaka+Division,+Bangladesh&amp;t=m&amp;ll=23.742671,90.378728&amp;spn=0.005892,0.020149&amp;z=16&amp;output=embed"></iframe><br />
		
        <div id="footer"><center>
        <H1 style="color:red; font-size:24px" align="center">Other Foods</h1><br /><br /><span>
       <a href="../BANGLA/ffc.php"> <input type="button" value="Bangla Foods" style="background-color:#0F0; color:red" size="50px" height="20px"/>  
         </a>
       <a href="../fast_foods/ffc.php"> 
       <input type="button" value="Fast Foods" style="background-color:#0F0" /> 
         </a>
       <a href="../THAI & CHINESE/ffc.php"> 
	  ...
	  <div id="leftcol">
				...
				<div class="block">
					...
					$squ=mysql_query("select * from restaurant where Category='Indian' and restaurent_name='FFC'");
					
					$result_count = mysql_num_rows($squ);
					if($result_count==0){
						echo '<h1>There is no Indian Food of <b style="color:#0FF">FFC</b></h1>';
					}else{
						
						if((isset($_SESSION['username']) and $_SESSION['username']=="admin")|| (isset($_SESSION['username']) and $_SESSION['username']=="FFC")){
