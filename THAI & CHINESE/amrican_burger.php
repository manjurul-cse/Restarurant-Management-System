	...
	<div id="page">
	  ...
	  <div id="leftcol">
				...
				<div class="block">
					...
					$squ=mysql_query("select * from restaurant where Category='Thai & Chinis' and restaurent_name='American Burger'");
					
					$result_count = mysql_num_rows($squ);
					if($result_count==0){
						echo '<h1>There is no Thai & Chinis of <b style="color:#0FF">American Burger</b></h1>';
					}else{
