	...
	<div id="page">
	  ...
	  <div id="leftcol">
				...
				<div class="block">
					...
					$squ=mysql_query("select * from restaurant where Category='Thai & Chinis' and restaurent_name='korai gost'");
					
					$result_count = mysql_num_rows($squ);
					if($result_count==0){
						echo '<h1>There is no Thai & Chinis Food of <b style="color:#0FF">korai gost</b></h1>';
					}else{
