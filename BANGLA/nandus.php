...
<body>
	<div id="page">
	  <div id="header">
       ...
       <a href="../fast_foods/nandus.php"> <input type="button" value="Fast Foods" style="background-color:#0F0; color:red" size="50px" height="20px"/> 
         </a>
       <a href="../INDIAN/nandus.php"> 
	  ...
	  <div id="leftcol">
				...
				<div class="block">
					...
					$squ=mysql_query("select * from restaurant where Category='bangla' and restaurent_name='nandus'");
					
					$result_count = mysql_num_rows($squ);
					if($result_count==0){
						echo '<h1>There is no Bangla Food of <b style="color:#0FF">Nandus</b></h1>';
					}else{
