...
<body>
	<div id="page">
      ...
      <a href="../fast_foods/bfc.php"> <input type="button" value="Fast Foods" style="background-color:#0F0; color:red" size="50px" height="20px"/>  
         </a>
       <a href="../INDIAN/bfc.php"> 
	  ...
	  <div id="leftcol">
				...
				<div class="block">
					...
					$squ=mysql_query("select * from restaurant where Category='bangla' and restaurent_name='Bfc'");
					
					$result_count = mysql_num_rows($squ);
					if($result_count==0){
						echo '<h1>There is no Banglat Food of <b style="color:#0FF">Bfc</b></h1>';
					}else{
